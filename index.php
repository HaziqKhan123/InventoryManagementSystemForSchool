						...
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form>
							  ...
							  <div class="form-row">
								...
								<div class="form-group col-md-3">
								  <label for="itemDetailsUnitPrice">Unit Price(RM)<span class="requiredIcon">*</span></label>
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						  <label for="purchaseDetailsUnitPrice">Unit Price(RM)<span class="requiredIcon">*</span></label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-3">
							<label for="vendorDetailsVendorMobile">Phone Number(+60)<span class="requiredIcon">*</span></label>
						  ...
						  <div class="form-group col-md-3">
							<label for="vendorDetailsVendorPhone2">Phone Number 2(+60)</label>
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						  <label for="saleDetailsUnitPrice">Unit Price(RM)<span class="requiredIcon">*</span></label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerMobile">Phone Number(+60)<span class="requiredIcon">*</span></label>
						  ...
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerPhone2">Phone Number 2 (+60)</label>
